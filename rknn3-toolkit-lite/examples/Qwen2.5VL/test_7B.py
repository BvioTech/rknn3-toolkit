...
RKNN_LLM_MODEL = '/userdata/rknn_Qwen2_5_VL_demo/model/llm_Qwen2.5-VL-7B.rknn'
RKNN_VISION_MODEL = '/userdata/rknn_Qwen2_5_VL_demo/model/vision_Qwen2.5-VL-7B.rknn'
EMBED_PATH = '/userdata/rknn_Qwen2_5_VL_demo/model/Qwen2.5-VL-7B.embed.bin'
TOKENIZER_PATH = './qwen2_5_VL_7B'


VOCAB_SIZE = 152064 # 可从config.json查询 vocab_size 字段
...
if __name__ == '__main__':
    ...
    img = cv2.resize(img, (392, 392)).transpose(2,0,1).reshape(1,3,392, 392)
    feature = prune_model_img_process(img) # prune版 qwen2.5vl-3b，若是完整版模型将这部分代码删除就行，可以参考mobilenet的例子
